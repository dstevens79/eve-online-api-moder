...
export function Corporations({ isMobileView = false }: CorporationsProps) {
  ...
  useEffect(() => {
    loadSystemInfo();
    addDebugLog('Corporations panel initialized');
  }, []);
      ...
      <Card>
        ...
        <CardContent>
          <Alert>
            ...
            <AlertDescription>
              Corporation-focused debug tools, connection tests, and system diagnostics. Use these tools to 
              troubleshoot corporation-related issues and validate system functionality.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
